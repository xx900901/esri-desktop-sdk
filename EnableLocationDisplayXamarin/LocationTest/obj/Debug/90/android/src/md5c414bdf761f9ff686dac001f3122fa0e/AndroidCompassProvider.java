...
public class AndroidCompassProvider
	extends md5c414bdf761f9ff686dac001f3122fa0e.CompassProvider
	implements
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime", AndroidCompassProvider.class, __md_methods);
	}
	...
	public AndroidCompassProvider ()
	{
		...
		if (getClass () == AndroidCompassProvider.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.Location.AndroidCompassProvider, Esri.ArcGISRuntime", "", this, new java.lang.Object[] {  });
	}
