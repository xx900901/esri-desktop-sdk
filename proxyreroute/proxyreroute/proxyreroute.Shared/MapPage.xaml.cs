...
using Xamarin.Forms;
using Color = System.UI.Color;
using Esri.ArcGISRuntime.Navigation;

namespace proxyreroute
{
    public partial class MapPage : ContentPage
    {
        ...
        private readonly MapPoint _aerospaceMuseum = new MapPoint(-81.9980352826826, 28.9167414059663, SpatialReferences.Wgs84);
        ...
        private async void Initialize()
        {
            try
            {
                ...
                //_routeTask = await RouteTask.CreateAsync(_networkGeodatabasePath, "Streets_ND"); https://utility.arcgis.com/usrsvcs/appservices/uoBbS3YqJ0gRi2Ab/rest/services/World/Route/NAServer/Route_World/solve
                Uri _carRoutingUri = new Uri("https://arc7.thevillages.com/arcgis/rest/services/CARROUTES/NAServer/Route");
                ...
                _routeAheadGraphic = new Graphic(_route.RouteGeometry) { Symbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dash, Color.Red, 5) };
